...
const Projects = () => {
  const projects = [
    { id: 1, name: "Sentiment Analysis of Banking Services", thumbnail: "banksense.png", details: "Analyzed 170,000+ customer reviews from top Canadian banks  using NLP,achieving 87% sentiment classification accuracy across positive, negative, and neutral sentiments. Developed a GCP-based data pipeline to automate scraping, preprocessing, and sentiment labeling, cutting manual effort by 80% and enabling biweekly batch updates. Built a Django-based Sentiment Dashboard with visualizations, boosting decision-making efficiency by 40%" },
    { id: 2, name: "Web Search Engine", thumbnail: "search-engine.png", details: "Enhanced query response time by 30% using a trie-based inverted index, achieving 20-50% faster performance than hash map, and reduced irrelevant results using edit distance matching and heap-based ranking for 1,000 queries.Achieved retrieval speed by 30% and reduced redundant scraped web links by storing them in a directed graph" },
    { id: 3, name: "Client Server File Retrieval Communication System", thumbnail: "client-server.jpg", details: "Implemented efficient, fault-tolerant handling of 10+ multi-client interactions by architecting a Linux-based client-server file retrieval system in C, utilizing socket communication and round-robin load balancing between main and mirror servers.Reduced manual intervention time by 67% per session by Implementing a multi-threaded architecture on a single server to handle 15+ client connections, alongside using shell scripting bash utilities for automated backup processes" },
    { id: 4, name: "EasyGo: Fare Payment System", thumbnail: "easygo.jpg", details: "Awarded a $500 cash prize in EPICentre’s VentureU Competition for developing a prototype fare payment software implemented face recognition using Python and OpenCV" },
    { id: 5, name: "EWaste Management System", thumbnail: "ewaste.png", details: "Developed a Python Django-based platform for e-waste recycling, implementing user authentication and request management features that enabled the creation of more than 50+ user accounts during testing phases.Engineered user-centric interfaces and backend logic, utilizing Django’s function and class-based views for better code organization and integrating session and cookie tracking with advanced caching techniques"},
    { id: 6, name: "Brick Breaker Game", thumbnail: "BrickBreaker.jpg", details: "Showcased strong logic-building, function calling, and control flow design skills.Implemented a dynamic ball trajectory, brick collision mechanism, and a user-controlled paddle for a classic gaming experience.Demonstrated programming proficiency, algorithmic thinking, and problem-solving abilities through game development" },
  ];
  ...
  return (
    <div className="projects-page">
      ...
      {/* working code without modal feature */}
      {/* Main Content */}
